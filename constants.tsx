...
export const NAV_ITEMS = [
  { id: 'dashboard', label: 'Dashboard', icon: <LayoutDashboard size={20} />, roles: ['ADMIN', 'TEACHER', 'ACADEMIC'] },
  ...
  { id: 'settings', label: 'Sozlamalar', icon: <Settings size={20} />, roles: ['ADMIN', 'TEACHER', 'ACADEMIC'] },
];
...
export const STORAGE_KEYS = {
  ...
  THEME: 'educontrol_theme',
  SCALE: 'educontrol_scale'
};
